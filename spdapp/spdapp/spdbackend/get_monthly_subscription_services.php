...
try {
    // Fetch monthly subscription services where main_category = 'monthly_subscription' or similar
    $query = "
        SELECT 
        ...
        FROM services 
        WHERE LOWER(TRIM(main_category)) = 'monthly_subscription'
    ...
    echo json_encode([
        ...
        'message' => 'Found ' . count($services) . ' monthly subscription services'
    ]);
} catch (Exception $e) {
    http_response_code(500);
    echo json_encode([
