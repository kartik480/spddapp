...
try {
    // Fetch one-time services where main_category = 'one_time'
    $query = "
        SELECT 
            ...
            duration, booking_advance_hours, category, subscription_plans, coupon_type,
        ...
        FROM services 
        WHERE LOWER(TRIM(main_category)) = 'one_time'
    ...
    echo json_encode([
        ...
        'message' => 'Found ' . count($services) . ' one-time services'
    ]);
} catch (Exception $e) {
    http_response_code(500);
    echo json_encode([
